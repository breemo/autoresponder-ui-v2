...
test("3. history appears as a role-separated recent transcript — both roles, current message last", () => {
  ...
  assert.equal(response.messages[3].content, "do you deliver outside Nablus?");
});
