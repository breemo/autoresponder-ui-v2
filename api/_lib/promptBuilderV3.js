...
function buildOutputContractV3() {
  return [
    ...
    '- "action_params" carries only the keys the chosen action needs ("name", "phone", "reason"). Omit it or leave it {} for "reply".',
